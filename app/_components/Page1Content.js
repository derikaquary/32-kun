...
import page from "@/public/23.png";
import { FaArrowDown } from "react-icons/fa6";
import { FaArrowUp } from "react-icons/fa";
import content from "@/public/content.jpeg";
...
function Page1Content() {
  return (
    <div className="relative flex h-[100vh] w-full flex-col items-center sm:justify-center">
      ...
      {/* Small Screen */}
      <div className="mt-[148px] flex h-[100vh] w-full flex-col gap-6 border-b-2 border-white px-3 py-4 sm:hidden bg-black/30 backdrop-blur-md">
