...
function Page2Brand() {
  return (
    <div className={`flex relative flex-col justify-center items-center w-full ${outfit.className}`}>
      <Image
        src={page}
      ...
      <div className="flex flex-col gap-3 justify-center px-2 pt-8 w-full bg-black/10 sm:hidden">
        <p className="text-5xl text-secondary font-[800] text-center">EVENT</p>
