...
function Page6Service() {
  return (
    <div className="relative flex w-full justify-center sm:h-[100vh] sm:pt-[50px]">
      ...
      />
      {/* Big Screen */}
      <div className=" hidden h-[100vh] w-full max-w-7xl flex-col items-center pt-[30px] sm:flex">
      ...
      {/* Small Screen */}
      <div className="flex flex-col gap-6 items-center px-2 py-8 w-full sm:hidden">
