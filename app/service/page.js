...
function Service() {
  return (
    <div className="px-2 sm:hidden bg-black/30 mt-[148px]">
      <p className="px-2 py-5 text-3xl font-[700] text-secondary text-center "> Please &#34;Click&#34; one of the options above</p>
